...
const Navbar = () => {
  ...
  const handleTouchEnd = () => {
    if (startXRef.current - currentXRef.current > 50) {
      setOpenMenu(false);
    } else if (currentXRef.current - startXRef.current > 50) {
      setOpenMenu(true);
    }
  };
      ...
      >
        <div className="profile-container ">
          ...
          <div className="userInfo">
            <div className="profile-name font-semibold text-lg ">John Doe</div>
